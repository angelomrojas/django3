    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facebook_link', models.CharField(default='#', max_length=100, verbose_name='Facebook')),
                ('twitter_link', models.CharField(default='#', max_length=100, verbose_name='Twitter')),
                ('instagram_link', models.CharField(default='#', max_length=100, verbose_name='Instagram')),
